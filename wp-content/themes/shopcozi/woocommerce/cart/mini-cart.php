...
<?php if ( ! WC()->cart->is_empty() ) : ?>
				...
				<li class="woocommerce-mini-cart-item <?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?>">
					...
					echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
						...
						sprintf(
							...
							esc_attr__( 'Remove this item', 'shopcozi' ),
							esc_attr( $product_id ),
	...
	<div class="shopping-cart-header">
		<div class="shopping-cart-total">
			<span class="lighter-text"><?php _e( 'Sub Total:', 'shopcozi' ); ?></span>
		...
		<div class="shoppingcart-bottom">
			<a href="<?php echo esc_url(wc_get_cart_url()); ?>" class="btn btn-primary"><?php echo esc_html_e('Cart','shopcozi'); ?></a>
			<a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="btn btn-primary"><?php echo esc_html_e('Checkout','shopcozi'); ?></a>
		</div>
...
<?php else : ?>
	...
	<p class="woocommerce-mini-cart__empty-message"><?php esc_html_e( 'No products in the cart.', 'shopcozi' ); ?></p>
