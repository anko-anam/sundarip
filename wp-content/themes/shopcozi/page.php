...
$blog_layout = $option['shopcozi_page_layout'];
$left_sidebar = $option['shopcozi_page_leftsidebar'];
$right_sidebar = $option['shopcozi_page_rightsidebar'];
$container_class = $option['shopcozi_page_container_width'];
